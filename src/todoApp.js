const todoApp = (function () {
  ...
  function createProject(projectTitle, projectDescription) {
    ...
    console.log(
      `${projectTitle} with a description of ${projectDescription} has been created!`
    );
    saveToStorage();
  }
    ...
    if (!localStorage.getItem("projectsArray")) {
      ...
      for (let project of parsedProjects) {
        convertedProjects.push(
          new Project(project.title, project.description, project.todos)
        );
      }
      ...
      convertedProjects.forEach((project) => {
        ...
        project.todos.forEach((todo, todoIndex) => {
          ...
          todo.checklist.forEach((checkItem, checkItemIndex) => {
            let tempCheckItem = new Checklist(
